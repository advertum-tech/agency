            ...
            <div className="col s12 l6 margin-on-medium-and-down">
              ...
              >
                ...
                >
                  ...
                  <path
                    d="M40 320 Q120 310 180 280 Q240 250 300 180 Q360 110 420 70 Q480 30 560 20 Q600 15 640 12"
                    fill="none"
                    stroke="#1a1a1a"
                    strokeWidth="2"
                  />
                  <path
                    d="M40 320 Q120 315 180 300 Q240 285 300 260 Q360 230 420 200 Q480 170 560 150 Q600 140 640 135"
                    fill="none"
                    stroke="#999"
                    strokeWidth="1.5"
                    strokeDasharray="6 4"
              ...
              <a
                href="/great-displacement"
                className={cn("flow-text", oona["item-title"])}
              >
                Великое вытеснение
              </a>
            </div>
            <div className="col s12 l6">
              ...
              >
                ...
                >
                  ...
                  {(
                    ["Types", "Config", "Repo", "Service", "Runtime", "UI"] as const
                  ).map((label, i) => {
                    const x = 80 + i * 90;
                    const y = 160;
                    return (
                  ...
                  <text
                    ...
                    textAnchor="middle"
                  >
                    Providers (auth, telemetry, connectors, feature flags)
                  </text>
                  <circle
                    cx="340"
                    cy="70"
                  ...
                  <path
                    d="M380 70 Q500 40 560 70 Q620 100 600 130 Q580 155 530 155"
                    fill="none"
                    stroke="#c00"
                    strokeWidth="1"
                    strokeDasharray="4 3"
